...
export const messages: Record<Locale, Messages> = {
  es: {
    ...
    hero: {
      ...
      lead: "Soy Renato — desarrollador full-stack. Diseño y construyo software a medida, plataformas SaaS y sistemas de gestión que se sienten claros, rápidos y hechos para tu operación.",
  ...
  en: {
    ...
    hero: {
      ...
      lead: "I'm Renato — a full-stack developer. I design and build custom software, SaaS platforms and management systems that feel clear, fast and made for the way you actually work.",
